...
#难度控制
#0最难
def resetHeightOffset(stage):
    return random.randint(25+5*stage,75-5*stage)
class Difficulty:
    stage = random.randint(0,5)
    pipeDistance = 80+30*stage
    heightOffset = random.randint(25+5*stage,75-5*stage)
